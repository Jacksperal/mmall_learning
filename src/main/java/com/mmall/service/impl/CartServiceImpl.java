...
public class CartServiceImpl implements ICartService {
    ...
    public ServerResponse<CartVo> add(Integer userId, Integer productId, Integer count) {
        ...
        if (cart == null) {
            ...
            cartItem.setChecked(Const.Cart.CHECKED);//在购物车中的选中状态
    ...
    private CartVo getCartVo(Integer userId) {
        ...
        if (!CollectionUtils.isEmpty(cartList)) {
            for (Cart cartItem : cartList) {
                ...
                cartProductVo.setUerId(cartItem.getUserId());
                ...
                if (product != null) {
                    ...
                    //计算总价
                    cartProductVo.setProductTotalPrice(BigDecimalUtil.mul(product.getPrice().doubleValue(), cartProductVo.getQuality()));
                }
        ...
        cartVo.setImageHost(MyPropertiesUtil.getProperty("ftp.server.http.prefix"));
        return cartVo;
    }
